...
fire the rev shell using curl via RCE 
use this payload [Dont forget to URL-Encode the payload before use]
...
user.txt
$ cat user.txt
50a61ee6c1d36e9313585ec7326747db
```
...
Total lines      = 2
root/root.txt
ef9e26074443505ca6d1c1b09cb1d9b2
```
# <3 BY SIG WOTTS
